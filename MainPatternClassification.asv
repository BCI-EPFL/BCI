...
hold on
scatter(dataTesting(EpochTesting.MITerm.labels==555,indexTraining(1)),dataTesting(EpochTesting.MITerm.labels==555,indexTraining(2)));
xlabel('Feauture ranked as 1');
ylabel('Feature ranked as 2');
title('Projection of the test data on the 2 most discriminative features')

%% ONLINE
[Trials,SmoothedTotal]=online(s{1,length(s)},Mu,Sigma,classifier,indexTraining(1:hyperparameters.Nsel),0.96);